...
const Herosec = () => {
  ...
  return (
    <div className="w-full flex gap-6 flex-col">
      <div className="fixed right-4 z-200 bottom-4 hover:scale-[110%] transition-all ease-in-out duration-500">
      <img className="h-13 w-13 cursor-pointer" src="https://cdn.prod.website-files.com/61ba09162b87002e87715b91/63b3f7edd7207902e22a2b83_intercom-chat.webp" alt="" />
      </div>

      <div className="w-full flex justify-center ">
        <h1
          ref={textRef}
          className="text-center  text-7xl tracking-wide leading-22 w-5xl font-bold"
        >
          Double Your Business with Perspective Funnels™
        </h1>
      </div>

      <div ref={secRef} className="flex mb-20 gap-6 flex-col">
        <div className="w-full flex justify-center">
          <p className="text-[20px] tracking-wide font-normal w-[850px] text-center text-(--para)">
            Easily create mobile-first, interactive, and personalized lead gen
            and sales funnels with market-leading conversion rates in just 30
            minutes. No design or coding skills required.
          </p>
        </div>
            ...
            <div className="flex w-7xl mask-x-from-70% mask-x-to-90% overflow-clip">
              <div ref={marqueeRef} className="flex shrink-0">
                {newImages.map((src, idx) => {
                  return (
                    <img className="w-40" src={src} key={idx} alt="home" />
                  );
                })}
              </div>
            </div>
