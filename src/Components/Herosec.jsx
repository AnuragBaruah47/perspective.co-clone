...
Used daily by more than 6,000 small and large businesses.
      ...
      <div className="flex w-full justify-center">
        <div className="flex w-5xl overflow-clip">
